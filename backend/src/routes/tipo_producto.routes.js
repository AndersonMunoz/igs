...
import { registroTipo_producto, editarTipo_producto, listarTipoProducto, buscartipo } from '../controllers/tipo_producto.controllers.js';
...
tipo_productoRouter.get("/buscar/:id", buscartipo);
