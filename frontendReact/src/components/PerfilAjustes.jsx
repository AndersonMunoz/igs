...
const PerfilAjustes = () => {
    ...
    // Función para desencriptar la contraseña del usuario seleccionado
    ...
    function actualizarContrasena(userId) {
        ...
        // Envía solo el ID del usuario en lugar de la contraseña
        fetch(`http://localhost:3000/usuario/editarcontrasena/${userId}`, {
            method: "PUT",
            headers: {
                "Content-type": "application/json",
            },
            // Envía la contraseña en el cuerpo de la solicitud
                                    ...
                                    <div className="col">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input
                                                ...
                                                onChange={handleChangeContrasena} // Actualizar contrasenaValue directamente
