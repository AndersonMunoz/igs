...
const LoginForm = () => {
  ...
  const navigate = useNavigate(); // Importa la función useNavigate
    ...
    fetch("http://localhost:3000/aut/validar", {
      ...
      .then((data) => {
        ...
        if (data.status === 200) {
          ...
          navigate("/dashboard"); // Usa la función navigate para redirigir
            ...
            <div className="d-flex align-items-start">
              <div className="remember">
                ...
                <label className="option text-muted">
                  {" "}
                  Recordarme <input type="radio" name="radio" />{" "}
