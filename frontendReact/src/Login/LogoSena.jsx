...
const LogoSena = () => (
    <svg className="logoSenass" viewBox="0 0 63.67 62.2" width="60px" height="60px">
        <path fill="rgb(57, 169, 0)" d="M32,0c3.77,0,6.85,3.1,6.85,6.9s-3.07,6.9-6.85,6.9-6.85-3.1-6.85-6.9S28.23,0,32,0" />
        <path fill="rgb(57, 169, 0)"
